!function (f, l) {
    ...
    return l = l && l.hasOwnProperty("default") ? l.default : l, function (h) {
        ...
        var w = h.parent, L = h.displacementImage, M = h.image1, P = h.image2, U = F(h.intensity1, h.intensity, 1),
            V = F(h.intensity2, h.intensity, 1), C = F(h.angle, Math.PI / 4), D = F(h.angle1, C),
            S = F(h.angle2, 3 * -C), W = F(h.speedIn, h.speed, 1.6), _ = F(h.speedOut, h.speed, 1.2),
            z = F(h.hover, !0), q = F(h.easing, Expo.easeOut), G = F(h.video, !1);
        if (w) if (M && P && L) {
            var A = new f.Scene,
